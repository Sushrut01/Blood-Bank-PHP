...
<body>
  <div class="container">
    <div class="row">
      <div class="col-md-7">
        <h1 class="text-left">Login Yourself Here</h1>
        <p class="text-left">
       ...
       <div class="col-md-5">
         ...
         <div class="row">
           ...
           <div class="col-md-6">
            <a href="PReg.php"><button type="button" class="btn btn-primary">Sign Up</button></a>
           </div>
         </div>
         <!--close-->
         <hr>
		...
		<p style="color:yellow"><?php echo $error?></p>
         ...
         <marquee><h4>!!!Please Sign Up if you are a new user!!!</h4></marquee>
